...
//! ![here is a pumpkin picture!](https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/FrenchMarketPumpkinsB.jpg/700px-FrenchMarketPumpkinsB.jpg)
...
/// # Recipes
///
/// Recipes will surely be coming any time now!
pub struct Pumpkin {
    /// Roundness is a percentage, from 0.0 to 1.0
    pub roundness: f32,
...
/// `BURNT_ORANGE` is to be used in the `orangeness` field in the [`Pumpkin`] struct.
